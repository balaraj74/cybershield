                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                        <Card variant="elevated">
                            <CardContent className="py-6 text-center">
                                ...
                                <div className="mt-1 text-sm text-neutral-400">Privacy Score</div>
                        ...
                        <Card variant="elevated">
                            <CardContent className="py-6 text-center">
                                ...
                                <div className="mt-2 text-sm text-neutral-400">Overall Assessment</div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="py-6 text-center">
                                <div className="flex justify-center gap-4">
                                    <div>
                                        ...
                                        <div className="text-xs text-neutral-400">Data Types</div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-neutral-400">3rd Parties</div>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                                    ...
                                    <tbody className="text-sm">
                                        {analysis.dataCollected.map((data, index) => (
                                            <tr key={index} className="border-b border-neutral-800">
                                                ...
                                                <td className="py-2 text-neutral-400">{data.purpose}</td>
                                                <td className="py-2">
